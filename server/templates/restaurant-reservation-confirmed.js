EmailService.Templates.forgotPassword = {
  path: 'emails/themes/metro/emails/restaurant-reservation-confirmed.html',    // Relative to the 'private' dir.
  ...
  route: {
    path: '/restaurant-reservation-confirmed/:name',
    data: function() {
      var hotel = {
        name: 'City Club',
        geo: {
      ...
      return {
        ...
        viewInBrowserUrl: 'http://localhost:3000/emails/preview/restaurant-reservation-confirmed'
      };
    }
  }
};
