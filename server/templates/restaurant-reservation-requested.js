EmailService.Templates.forgotPassword = {
  path: 'emails/themes/metro/emails/restaurant-reservation-requested.html',    // Relative to the 'private' dir.
  ...
  route: {
    path: '/restaurant-reservation-requested/:name',
    data: function() {
      var hotel = {
        name: 'City Club',
        geo: {
      ...
      return {
        ...
        viewInBrowserUrl: 'http://localhost:3000/emails/preview/restaurant-reservation-requested'
      };
    }
  }
};
